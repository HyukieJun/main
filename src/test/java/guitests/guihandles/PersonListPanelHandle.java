 ...
 */
public class PersonListPanelHandle extends NodeHandle<ListView<Member>> {
    public static final String PERSON_LIST_VIEW_ID = "#personListView";

    private static final String CARD_PANE_ID = "#cardPane";

    private Optional<Member> lastRememberedSelectedPersonCard;

    public PersonListPanelHandle(ListView<Member> personListPanelNode) {
    ...
    private Member getPerson(int index) {
